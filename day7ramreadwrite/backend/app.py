...
# FILE PATHS
# =========================================================
RAM_SV   = os.path.join(PROJECT_DIR, "ramreadwrite.sv")
TB_PY    = os.path.join(PROJECT_DIR, "testbench_ramreadwrite.py")
NETLIST  = os.path.join(PROJECT_DIR, "ram_netlist.v")
VCD      = os.path.join(PROJECT_DIR, "ram.vcd")
PNG      = os.path.join(PROJECT_DIR, "ram.png")
...
def validate():
    ...
    prompt = "Review these RAM design artifacts:\n\n" + "\n\n".join(artifacts)
