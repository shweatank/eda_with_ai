...
module sub_unsigned(a, b, diff);
  ...
  assign diff[2] = ~(_05_ ^ _02_);
  assign _06_ = a[3] ^ b[3];
  assign _07_ = b[2] | ~(a[2]);
  assign _08_ = _05_ & ~(_02_);
  assign _09_ = _07_ & ~(_08_);
  assign diff[3] = _09_ ^ _06_;
  assign _10_ = a[4] ^ b[4];
  assign _11_ = b[3] | ~(a[3]);
  ...
  assign diff[4] = _16_ ^ _10_;
  assign _17_ = a[5] ^ b[5];
  assign _18_ = b[4] | ~(a[4]);
  assign _19_ = ~(_16_ | _10_);
  assign _20_ = _18_ & ~(_19_);
  assign diff[5] = _20_ ^ _17_;
  assign _21_ = a[6] ^ b[6];
  assign _22_ = b[5] | ~(a[5]);
  ...
  assign diff[6] = _27_ ^ _21_;
  assign _28_ = a[7] ^ b[7];
  assign _29_ = b[6] | ~(a[6]);
  assign _30_ = ~(_27_ | _21_);
  assign _31_ = _29_ & ~(_30_);
  assign diff[7] = _31_ ^ _28_;
endmodule
