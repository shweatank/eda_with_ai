...
async def test_simple_ram(dut):
    ...
    print(f"TEST 2: read address 0x10 | expected=0xAA actual=0x{read_value:02X}")
    ...
    print(f"TEST 4: read address 0x20 | expected=0x55 actual=0x{read_value:02X}")
    ...
    print(f"TEST 5: read address 0x10 again | expected=0xAA actual=0x{read_value:02X}")
